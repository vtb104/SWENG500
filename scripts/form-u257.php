...
function emailFormSubmission()
{
	...
	$to = 'hannahmisssmomma@gmail.com';
	$subject = 'Send Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>To:</b></td><td>' . htmlentities($_REQUEST["custom_U264"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Subject:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U258"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>From:</b></td><td>' . htmlentities($_REQUEST["custom_U274"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Urgency:</b></td><td>' . htmlentities($_REQUEST["custom_U278"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: hannahmisssmomma@gmail.com' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.328 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
